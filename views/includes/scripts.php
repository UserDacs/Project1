...
<!-- DataTables -->
<script src="<?php echo ROOT ?>bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
...
<!-- ChartJS -->
<script src="<?php echo ROOT ?>bower_components/chart.js/Chart.js"></script>
<!-- Sparkline -->
<script src="<?php echo ROOT ?>bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="<?php echo ROOT ?>bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="<?php echo ROOT ?>bower_components/moment/min/moment.min.js"></script>
<script src="<?php echo ROOT ?>bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="<?php echo ROOT ?>bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- bootstrap time picker -->
<script src="<?php echo ROOT ?>plugins/timepicker/bootstrap-timepicker.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo ROOT ?>plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
<script src="<?php echo ROOT ?>bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="<?php echo ROOT ?>bower_components/fastclick/lib/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="<?php echo ROOT ?>dist/js/adminlte.min.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?php echo ROOT ?>dist/js/pages/dashboard.js"></script>
